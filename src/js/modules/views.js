...
`,
      ...
      <div class="card" style="margin-top:16px">
        ...
        <div style="display:flex;gap:6px;flex-wrap:wrap;margin-top:8px;align-items:center">
          ...
          <button class="btn btn-secondary" onclick="Konsole.protokolleDialog()" title="Welche Rechner schreiben Protokolle für diese Datenbank, wie groß und wie alt sind sie, was ist hier noch ungelesen – zum Vergleich mit dem anderen Rechner">▤ Protokolle im Ordner</button>
