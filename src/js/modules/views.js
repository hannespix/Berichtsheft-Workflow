      ...
      <div style="display:grid;grid-template-columns:240px 1fr;gap:16px;align-items:start">
        ...
        <div style="font-size:13px;line-height:1.7">
          ...
          <div id="help_14" class="card" style="margin-bottom:12px;border-left:4px solid var(--clr-amber)">
            ...
            <p>1. Alle Sachbearbeiter öffnen die gleiche HTML-Datei und wählen denselben Arbeitsordner</p>
          ...
          <div id="help_18" class="card" style="margin-bottom:12px;border-left:4px solid var(--clr-amber)">
            ...
            <p>• Jeder Sachbearbeiter öffnet die HTML-Datei lokal im Browser und wählt denselben Ordner</p>
          ...
          <div id="help_23" class="card" style="margin-bottom:12px">
            ...
            Ja. Der Arbeitsordner wird auf einem gemeinsamen Netzlaufwerk abgelegt. Alle Sachbearbeiter öffnen die HTML-Datei im Browser und wählen denselben Ordner. Das integrierte Synchronisationssystem gleicht Änderungen im 8-Sekunden-Intervall ab und verhindert durch ein Sperrsystem gleichzeitige Bearbeitung desselben Datensatzes.</p>
