    ...
    const rows = schueler.map((s, i) => {
      ...
      return `<tr style="${isPA ? 'background:var(--clr-red-light) !important;border-left:4px solid var(--clr-red)' : !isAnw ? 'opacity:0.5;background:var(--clr-warm)' : isDone && !isOK ? 'background:var(--clr-red-light)' : isDone && isOK ? 'background:var(--clr-green-light)' : ''}">
        ...
        <td>
          ...
          <div style="font-size:10px;color:var(--clr-text-light)">${esc(s.ausbildungsstaette||'')} <a href="#" onclick="event.preventDefault();AzubiDashboard.open(${s.id})" ${typeof AzubiDashboard!=='undefined'&&AzubiDashboard.isEnabled()?'':'style="display:none"'} style="color:var(--clr-forest);text-decoration:none" title="Azubi-Dashboard">&#127891;</a></div>
        </td>
        ...
        <div style="display:flex;align-items:center;justify-content:space-between">
          ...
          <div style="text-align:center">
            ...
            <div style="font-size:12px;color:var(--clr-text-light)">
              ...
              · <a href="#" onclick="event.preventDefault();AzubiDashboard.open(${s.id})" ${typeof AzubiDashboard!=='undefined'&&AzubiDashboard.isEnabled()?'':'style="display:none"'} style="color:var(--clr-forest);text-decoration:none;font-weight:600">&#127891; Dashboard</a>
            </div>
