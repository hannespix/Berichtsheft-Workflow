...
console.log('\n══ Einstellungen in Reitern, Wartung als Menüpunkt ══');
{
  ...
  check(/id="einstTab_persoenlich"[^>]*>\$\{t\.darstellung\}\$\{t\.menue\}/.test(V) && /id="einstTab_kontakt"[^>]*>\$\{t\.kontakt\}\$\{t\.aemter\}\$\{t\.vorlagen\}\$\{t\.word\}/.test(V) && /id="einstTab_regeln"[^>]*>\$\{t\.zulassung\}\$\{t\.lfk\}\$\{t\.ferien\}\$\{t\.textbausteine\}/.test(V), 'Persönlich: Darstellung + Menü · Kontakt: Kontaktdaten, Ämter, Vorlagen, Word · Regeln: Zulassung, LFK, Ferien, Textbausteine');
