...
console.log('\n══ Einstellungen in Reitern, Wartung als Menüpunkt ══');
{
  ...
  check(/id="einstTab_persoenlich"[^>]*>\$\{t\.darstellung\}\$\{t\.menue\}/.test(V) && /id="einstTab_kontakt"[^>]*>\$\{t\.kontakt\}\$\{t\.aemter\}\$\{t\.vorlagen\}\$\{t\.word\}/.test(V) && /id="einstTab_regeln"[^>]*>\$\{t\.lfk\}\$\{t\.ferien\}\$\{t\.textbausteine\}/.test(V), 'Persönlich: Darstellung + Menü · Kontakt: Kontaktdaten, Ämter, Vorlagen, Word · Regeln: LFK, Ferien, Textbausteine');
...
console.log('\n══ Hilfe in zwölf Kapiteln ══');
{
  ...
  check(/HILFE_MAP: \{ dashboard: 'help_1', stammdaten: 'help_2', import: 'help_3', planung: 'help_4', kontrolle: 'help_5', nacherfassung: 'help_3', wiedervorlagen: 'help_6', berichte: 'help_7', einstellungen: 'help_10', wartung: 'help_10', hilfe: 'help_0' \}/.test(APP), 'Kontexthilfe je Ansicht zeigt ins passende Kapitel');
