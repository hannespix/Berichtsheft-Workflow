...
| `azubi-seite-test.mjs` | Azubi-Seite: Registrierung (index.html, build.sh, Ansicht, Hilfe), Abschnitte statt Dialoge (Stammdaten, Verlauf, Akte, Kontrollen, Wiedervorlagen), Fußknöpfe nur für den Dialog entfallen, Speichern/Bemerkung bleiben auf der Seite, Phasen-Formular bleibt Dialog, außerhalb der Seite weiter Dialoge, `istOffen` |
